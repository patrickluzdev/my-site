<template>
  <div>
    <div class="mb-6">
      ...
      <h1 class="text-3xl font-bold">Nova Configuração</h1>
      <p class="text-muted-foreground mt-1">Crie uma nova configuração do site</p>
    </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    toast.error(error?.data?.message || 'Erro ao criar configuração')
  } finally {
    loading.value = false
  }
}
